...
def save_model_cache(file_path: str, model_data: Dict[str, Any], model_class: Type[Cacheable], key: str):
    cache_data = {
...
def load_model_cache(file_path: str, model_class: Type[Cacheable], key: str) -> Dict[str, Any]:
